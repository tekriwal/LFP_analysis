...
elseif strcmp(subj, 'PT6')
filenames = 'BlwTrgt_6_01397';  
end
...
%         
        ...
        elseif strcmp(subj, 'PT6')
        load ([homeDir PT '/input_matrix_rndm_April4_case1']) %AT loads input matrix
        load ([homeDir PT '/rsp_master_v3_CASE1_45trials']) %AT loads rsp
        end
...
%         LFP_wholerecordings_uint16 = CLFP_02; 
        LFP_wholerecordings_uint16 = CLFP_03; 
